function CSlotSettings(){
    ...
    this._initSymbolWin = function(){
        ...
        s_aSymbolWin[8] = PAYTABLE_VALUES[8];
    };
    ...
    this._initSymbolAnims = function(){
        ...
        oData = {   
                        framerate: 20,
                        images: [s_oSpriteLibrary.getSprite('symbol_14_anim')], 
                        // width, height & registration point of each sprite
                        frames: {width: SYMBOL_SIZE, height: SYMBOL_SIZE, regX: 0, regY: 0}, 
                        animations: {  static: [0, 1],anim:[1,14] }
        };

        s_aSymbolAnims[13] = new createjs.SpriteSheet(oData);

        oData = {   
                        framerate: 20,
                        images: [s_oSpriteLibrary.getSprite('symbol_15_anim')], 
                        // width, height & registration point of each sprite
                        frames: {width: SYMBOL_SIZE, height: SYMBOL_SIZE, regX: 0, regY: 0}, 
                        animations: {  static: [0, 1],anim:[1,14] }
        };

        s_aSymbolAnims[14] = new createjs.SpriteSheet(oData);
    };
