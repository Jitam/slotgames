function CPayTablePanel(){
    ...
    this._createPayouts = function(){
        ...
        var aPos = [{x:450,y:122},{x:450,y:302},{x:450,y:486}, {x:780,y:122},{x:780,y:302},{x:780,y:486}, {x:1100,y:122},{x:1100,y:302},{x:1100,y:486}];
        var iCurPos = 0;
    ...
    this.highlightCombo = function(iSymbolValue,iNumCombo){
        ...
        //_aWinComboText[iSymbolValue-1][iNumCombo].color = "#ff0000";
        //this.tweenAlpha(_aWinComboText[iSymbolValue-1][iNumCombo],0);
