function CInterface(iCurBet,iTotBet,iMoney){
	...
	_oMoneyText = new createjs.Text(TEXT_MONEY +"\n"+iMoney.toFixed(2)+TEXT_CURRENCY,"24px "+FONT_GAME, "#ffde00");
        ...
        _oWinText.x = 1116;
        _oWinText.y = CANVAS_HEIGHT - 96+5;
        _oWinText.textAlign = "center";
        _oWinText.textBaseline = "alphabetic";
        s_oStage.addChild(_oWinText);
                
        _oFreeSpinText = new createjs.Text("","20px "+FONT_GAME, "#ffde00");
        _oFreeSpinText.x = 1116-5;
        _oFreeSpinText.y = CANVAS_HEIGHT - 96-15;
        _oFreeSpinText.textAlign = "center";
        _oFreeSpinText.textBaseline = "alphabetic";
        s_oStage.addChild(_oFreeSpinText);
    ...
    this.refreshFreeSpinText = function(iFreeSpin){
        if(iFreeSpin) {
            _oFreeSpinText.text = TEXT_FREESPIN;
        } else {
            _oFreeSpinText.text = "";
        }
    ...
    this.disableFreeSpinGuiButtons = function(){
        _oSpinBut.enable();
        _oMaxBetBut.disable();
        _oBetCoinBut.disable();
        _oAddLineBut.disable();
